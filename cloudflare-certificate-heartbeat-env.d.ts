/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.certificate-heartbeat.jsonc --env-interface=CertificateHeartbeatEnv cloudflare-certificate-heartbeat-env.d.ts` (hash: 27b1c97561ca67d5cb55d28fa5d43cd0)
// Runtime types generated with workerd@1.20260801.1 2026-08-24 
interface __BaseEnv_CertificateHeartbeatEnv {
	HEARTBEAT_STATE: KVNamespace;
	ALERT_EMAIL: SendEmail;
	STATUS_URL: "https://raw.githubusercontent.com/wflores9/Ward-Protocol-OS/main/docs/security/evidence/certificate-reproducibility-status.json";
	MAX_STATUS_AGE_SECONDS: "691200";
	EXPECTED_CERTIFICATE_COUNT: "1";
	ALERT_FROM: "Ward Certificate Monitor <monitor@alerts.wardprotocol.org>";
	ALERT_TO: "wflores_9@outlook.com";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/certificate-heartbeat");
	}
	interface Env extends __BaseEnv_CertificateHeartbeatEnv {}
}
interface CertificateHeartbeatEnv extends __BaseEnv_CertificateHeartbeatEnv {}
